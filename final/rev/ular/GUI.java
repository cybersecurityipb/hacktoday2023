...
public class GUI extends JPanel implements KeyListener {
    ...
    public static void main(String[] args) {
        ...
        URL imageUrl = GUI.class.getResource("/com/images/Ular.png");
        ImageIcon icon = new ImageIcon(imageUrl);
        frame.setIconImage(icon.getImage());
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        GUI gui = new GUI(frameWidth, frameHeight);
        frame.add(gui);
...
class GameLogic implements Drawable {
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            try {
                InputStream imageStream = GUI.class.getResourceAsStream("/com/images/Ular.png");
